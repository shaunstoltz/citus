...
CREATE FUNCTION pg_catalog.distribute_function(function_name regproc,
                                               distribution_arg text DEFAULT NULL,
                                               colocate_with text DEFAULT 'default')
RETURNS bool
LANGUAGE C STRICT
AS 'MODULE_PATHNAME', $$distribute_function$$;
COMMENT ON FUNCTION pg_catalog.distribute_function(regproc, text, colocate_with text)
IS 'replicate a function on all nodes';
